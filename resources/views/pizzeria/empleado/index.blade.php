...
<div class="card">
    <div class="card-header p-2">
        <ul class="nav nav-pills">
            <li class="nav-item"><a class="nav-link active" href="#empleado-tab"
                    data-toggle="tab"><i class="fas fa-user"></i>&nbsp;&nbsp;Clientes</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="#empleado-eliminados-tab"
...
<div class="card-body">
    ...
    <div class="tab-content">
        <!------------------- INDEX ------------------->
        <div class="active tab-pane" id="empleado-tab">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <div id="toolbar">
                        <a id="btn-nuevo-empleado" class="btn btn-success">
                            <i class="fas fa-plus"></i> Nuevo
                        </a>
                    </div>
                    <table 
                        class="table-bordered table-hover table-striped"
                        id="tabla-empleado" data-show-export="true" data-search="true"
                        ...
                        <thead>
                            <tr>
                                <th data-sortable="true" data-field="id_empleado">ID</th>
                                ...
                                <th data-sortable="true" data-field="sueldo">Sueldo</th>
        ...
        <!------------------- ELIMINADOS ------------------->
        <div class="tab-pane" id="empleado-eliminados-tab">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <table 
                        class="table-bordered table-hover table-striped"
                        id="tabla-empleado-eliminados" 
...
<div class="modal fade" id="modal-nuevo-empleado" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="sueldo" type="number" class="form-control" id="sueldo" placeholder="Ej: 10" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal-footer">
            ...
            <button id="guardar-empleado" type="button" class="btn btn-success">
  ...
  <div class="modal fade" id="modal-edit-empleado" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    ...
                    <div class="form-group row">
                        <label for="sueldo-edit" class="col-sm-4 col-form-label">Sueldo:</label>
                        <div class="col-sm-8">
                            <input name="sueldo-edit" type="number" class="form-control" id="sueldo-edit" placeholder="Ej: 10" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal-footer">
            ...
            <button id="actualizar-empleado" type="button" class="btn btn-success">
...
@section('js')
    ...
    <script src="{{asset('/pizzeria/js/empleado.js')}}"></script>
@stop