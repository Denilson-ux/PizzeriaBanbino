...
<div class="card">
    <div class="card-header p-2">
        <ul class="nav nav-pills">
            <li class="nav-item"><a class="nav-link active" href="#tipo-vehiculo-tab"
                    data-toggle="tab"><i class="fas fa-user"></i>&nbsp;&nbsp;Roles</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="#tipo-vehiculo-eliminados-tab"
...
<div class="card-body">
    ...
    <div class="tab-content">
        <!------------------- INDEX ------------------->
        <div class="active tab-pane" id="tipo-vehiculo-tab">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <div id="toolbar">
                        <a id="btn-nuevo-tipo-vehiculo" class="btn btn-success">
                            <i class="fas fa-plus"></i> Nuevo
                        </a>
                    </div>
                    <table 
                        class="table-bordered table-hover table-striped"
                        id="tabla-tipo-vehiculo" data-show-export="true" data-search="true"
                        ...
                        <thead>
                            <tr>
                                <th data-sortable="true" data-field="id_tipo_vehiculo">ID</th>
        ...
        <!------------------- ELIMINADOS ------------------->
        <div class="tab-pane" id="tipo-vehiculo-eliminados-tab">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <table 
                        class="table-bordered table-hover table-striped"
                        id="tabla-tipo-vehiculo-eliminados" 
...
<div class="modal fade" id="modal-nuevo-tipo-vehiculo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <div class="form-group row d-flex" >
                        ...
                        <div class="col-sm-12">
                            <input name="nombre" id="nombre" type="text" class="form-control" placeholder="Auto">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer">
            ...
            <button id="guardar-tipo-vehiculo" type="button" class="btn btn-success">
...
<div class="modal fade" id="modal-editar-tipo-vehiculo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Editar tipo vehiculo</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="row">
        ...
        <div class="modal-footer">
            ...
            <button id="actualizar-tipo-vehiculo" type="button" class="btn btn-success">
...
@section('js')
    ...
    <script src="{{asset('/pizzeria/js/tipo_vehiculo.js')}}"></script>
@stop